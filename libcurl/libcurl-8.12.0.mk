...
CURL_SOURCES = $(CURL_CUR_DIR)/lib/vauth/cleartext.c    		\
...
$(CURL_CUR_DIR)/lib/vssh/curl_path.c  \
$(CURL_CUR_DIR)/lib/vssh/libssh2.c    \
$(CURL_CUR_DIR)/lib/vssh/libssh.c     \
$(CURL_CUR_DIR)/lib/vssh/wolfssh.c    \
...
$(CURL_CUR_DIR)/lib/vtls/vtls_scache.c         \
$(CURL_CUR_DIR)/lib/vtls/vtls_spack.c          \
...
$(CURL_CUR_DIR)/lib/vquic                    \
$(CURL_CUR_DIR)/lib/warnless.c               \
$(CURL_CUR_DIR)/lib/ws.c                     \
				# $(CURL_CUR_DIR)/src/slist_wc.c          \
				# $(CURL_CUR_DIR)/src/terminal.c          \
				# $(CURL_CUR_DIR)/src/tool_bname.c        \
				# $(CURL_CUR_DIR)/src/tool_cb_dbg.c       \
				# $(CURL_CUR_DIR)/src/tool_cb_hdr.c       \
				# $(CURL_CUR_DIR)/src/tool_cb_prg.c       \
				# $(CURL_CUR_DIR)/src/tool_cb_rea.c       \
				# $(CURL_CUR_DIR)/src/tool_cb_see.c       \
				# $(CURL_CUR_DIR)/src/tool_cb_soc.c       \
				# $(CURL_CUR_DIR)/src/tool_cb_wrt.c       \
				# $(CURL_CUR_DIR)/src/tool_cfgable.c      \
				# $(CURL_CUR_DIR)/src/tool_dirhie.c       \
				# $(CURL_CUR_DIR)/src/tool_doswin.c       \
				# $(CURL_CUR_DIR)/src/tool_easysrc.c      \
				# $(CURL_CUR_DIR)/src/tool_filetime.c     \
				# $(CURL_CUR_DIR)/src/tool_findfile.c     \
				# $(CURL_CUR_DIR)/src/tool_formparse.c    \
				# $(CURL_CUR_DIR)/src/tool_getparam.c     \
				# $(CURL_CUR_DIR)/src/tool_getpass.c      \
				# $(CURL_CUR_DIR)/src/tool_help.c         \
				# $(CURL_CUR_DIR)/src/tool_helpers.c      \
				# $(CURL_CUR_DIR)/src/tool_ipfs.c         \
				# $(CURL_CUR_DIR)/src/tool_libinfo.c      \
				# $(CURL_CUR_DIR)/src/tool_listhelp.c     \
				# $(CURL_CUR_DIR)/src/tool_main.c         \
				# $(CURL_CUR_DIR)/src/tool_msgs.c         \
				# $(CURL_CUR_DIR)/src/tool_operate.c      \
				# $(CURL_CUR_DIR)/src/tool_operhlp.c      \
				# $(CURL_CUR_DIR)/src/tool_paramhlp.c     \
				# $(CURL_CUR_DIR)/src/tool_parsecfg.c     \
				# $(CURL_CUR_DIR)/src/tool_progress.c     \
				# $(CURL_CUR_DIR)/src/tool_setopt.c       \
				# $(CURL_CUR_DIR)/src/tool_sleep.c        \
				# $(CURL_CUR_DIR)/src/tool_ssls.c         \
				# $(CURL_CUR_DIR)/src/tool_stderr.c       \
				# $(CURL_CUR_DIR)/src/tool_strdup.c       \
				# $(CURL_CUR_DIR)/src/tool_urlglob.c      \
				# $(CURL_CUR_DIR)/src/tool_util.c         \
				# $(CURL_CUR_DIR)/src/tool_vms.c          \
				# $(CURL_CUR_DIR)/src/tool_writeout.c     \
				# $(CURL_CUR_DIR)/src/tool_writeout_json.c\
				# $(CURL_CUR_DIR)/src/tool_xattr.c        \
				# $(CURL_CUR_DIR)/src/var.c               \



CURL_CFLAGS = -I$(CURL_CUR_DIR)/include                \
		-I$(CURL_CUR_DIR)/src                          \
		-I$(CURL_CUR_DIR)/lib                          \
		-I$(CURL_CUR_DIR)/lib/vauth                    \
		-I$(CURL_CUR_DIR)/lib/vquic                    \
		-I$(CURL_CUR_DIR)/lib/vssh                     \
		-I$(CURL_CUR_DIR)/lib/vtls						\
		# -DHAVE_CONFIG_H \
		# -DCURLDEBUG \
		# -DBUILDING_LIBCURL